      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview {{ ($prefix == '/admin.brand') ? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.brands') }}"><i class="ti-more"></i>All Brands</a></li>
          </ul>
        </li>
        <li class="treeview {{ ($prefix == '/admin.category') ? 'active':'' }}">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.categories') }}"><i class="ti-more"></i>All Categories</a></li>
          </ul>
        </li> 
